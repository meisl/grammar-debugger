...
class Hooks_04 is Metamodel::GrammarHOW {
...
# -----------------------------------------------------------------------------
    ...
    method describe(Mu: |args) {
        'Regexes and `&(sub)parse` wrapped only once each, `find_method` NOT overridden, method cache ENabled'
    }
